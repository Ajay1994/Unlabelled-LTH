...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print('Parameters: {}'.format(num_parameters))
         ...
         # train in one epoch
        train_loss, train_AUCs, train_acc = train(trainloader, model, criterion, optimizer, epoch, use_cuda)
